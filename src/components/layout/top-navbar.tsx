...
const TopNavbar: React.ComponentType<Props> = ({
  ...
  return <div className='fixed w-screen max-w-3xl left-1/2 transform -translate-x-1/2 dark:bg-alta-black bg-alta-white justify-between items-center flex px-4 pb-4'>
