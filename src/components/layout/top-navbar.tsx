...
const TopNavbar: React.ComponentType<Props> = ({ title }) => {
  // const router = useRouter();

  return (
    <div className="fixed border md:border-none w-screen max-w-3xl left-1/2 transform -translate-x-1/2 dark:bg-alta-black bg-white justify-between items-center flex p-4 z-50">
