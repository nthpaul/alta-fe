  ...
  return (
    ...
    >
      <Button
        ...
        className={clsx(pathname.startsWith(routes.home.href) && `p-2 bg-alta-gray-200 dark:bg-alta-gray-800 rounded-full text-alta-gray-700 dark:text-alta-white`)}
        onClick={() => router.push(routes.home.href)}
      />
      <Button
        MainIcon={() => <AlignCenterIcon className='w-10 h-10' />}
        className={clsx(pathname.startsWith(routes.shop.href) && `p-2 bg-alta-gray-200 dark:bg-alta-gray-800 rounded-full text-alta-gray-700 dark:text-alta-white`)}
        onClick={() => router.push(routes.shop.href)}
      />
      <Button
        MainIcon={() => <ShirtIcon className='w-10 h-10' />}
        className={clsx(pathname.startsWith(routes.outfits.href) && `p-2 bg-alta-gray-200 dark:bg-alta-gray-800 rounded-full text-alta-gray-700 dark:text-alta-white`)}
        onClick={() => router.push(routes.outfits.href)}
      />
      <Button
        MainIcon={() => <BookmarkIcon className='w-10 h-10' />}
        className={clsx(pathname.startsWith(routes.wishlist.href) && `p-2 bg-alta-gray-200 dark:bg-alta-gray-800 rounded-full text-alta-gray-700 dark:text-alta-white`)}
