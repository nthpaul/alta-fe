  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className={clsx(pathname.startsWith(routes.shop.href) && `p-2 bg-alta-gray-200 dark:bg-alta-gray-800 rounded-full text-alta-gray-700 dark:text-alta-white`, hover)}
